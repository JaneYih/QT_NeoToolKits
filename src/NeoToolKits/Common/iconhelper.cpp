...
{
    int fontId = QFontDatabase::addApplicationFont(":/MainWindowDialog/rc/font-awesome/fontawesome-webfont.ttf");
    ...
    if (fontName.count() > 0) {
        ...
        QMessageBox::critical(nullptr, "ERROR", QString::fromStdWString(L"load fontawesome-webfont.ttf error"));
    }
}

QFont IconHelper::GetIconFont() const
{
    return iconFont;
}
