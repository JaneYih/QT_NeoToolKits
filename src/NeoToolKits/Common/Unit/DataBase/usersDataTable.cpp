...
bool CUsersDataTable::InsertData(vector<string> para) //增
{
	if (!DatabaseInstence->IsInit())
	{
		return false;
...
bool CUsersDataTable::SelectData(vector<string> para, DataTable& outputData) //查
{
	if (!DatabaseInstence->IsInit())
	{
		return false;
...
bool CUsersDataTable::DeleteData(vector<string> para) //删
{
	if (!DatabaseInstence->IsInit())
	{
		return false;
...
bool CUsersDataTable::UpdataData(vector<string> para) //改
{
	if (!DatabaseInstence->IsInit())
	{
		return false;
