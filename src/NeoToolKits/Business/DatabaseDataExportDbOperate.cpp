...
{}
//
//bool DatabaseDataExportDbOperate::InsertExcelData(const QList<QVector<UploadData>>& dataList, 
...
//}
//
//bool DatabaseDataExportDbOperate::UpdateExcelData_EmptyFill(const QList<QVector<UploadData>>& dataList,
//	const ExcelDataUploadConfig& stUploadConfig, pUploadingInfo pstUploadingInfo)
//{
//	return OperateExcelData(UploadOptions::UpdateCommand_EmptyFill, dataList, stUploadConfig, pstUploadingInfo);
//}
//
//bool DatabaseDataExportDbOperate::UpdateExcelData_Rewrite(const QList<QVector<UploadData>>& dataList,
//	const ExcelDataUploadConfig& stUploadConfig, pUploadingInfo pstUploadingInfo)
//{
//	return OperateExcelData(UploadOptions::UpdateCommand_Rewrite, dataList, stUploadConfig, pstUploadingInfo);
//}
//
//bool DatabaseDataExportDbOperate::OperateExcelData(UploadOptions type, const QList<QVector<UploadData>>& dataList,
//	const ExcelDataUploadConfig& stUploadConfig, pUploadingInfo pstUploadingInfo)
//{
...
//}
//
//QString DatabaseDataExportDbOperate::GenerateInsertCommand(const QString& tableName, 
...
//}
//
//QString DatabaseDataExportDbOperate::GenerateUpdateCommand(const QString& tableName,
//	const QVector<UploadData>& data, 
//	const QString& strProductionOrderID,
//	QString& displayText)
//{
...
//}
//
//QString DatabaseDataExportDbOperate::GenerateClearDataCommand(const QString& tableName,
//	const QVector<UploadData>& data,
//	const QString& strProductionOrderID,
//	QString& displayText)
//{
